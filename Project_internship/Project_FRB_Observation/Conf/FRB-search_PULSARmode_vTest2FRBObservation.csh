...
python2.7 /home/lbondonneau/scripts/pav/psrfits_search/flat_bandpass_clean2.py -flat_per_block -mean_threshold 6 -j 8 -f $FILE -o $FILE8b -pscrunch -clean -subblock 16
...
foreach LINE ("`cat $OUTPUT.ddplan`")
    ...
    set	dS =  #`echo $LINE | awk '{print $3}'` not sure why DDplan value seems too large
