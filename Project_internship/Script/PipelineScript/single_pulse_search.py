...
def main():
    ...
    parser.add_option("-c", "--chunklen", type="int", dest="chunklen", default=8000,
                      help="Chunk length, must be at least max_downfact less than fftlen=8192")    
    ...
    if not dosearch:
        ...
        for filenm in args:
            ...
            print 'timeseries shape', timeseries.shape, 'numblocks', numblocks, 'roundN', roundN, 'detrendlen', detrendlen
            ...
            for bad_block in bad_blocks:
                ...
                print 'bad_block id', bad_block, 'loind', loind, 'hiind', hiind
            ...
            for chunknum in xrange(numchunks):
                ...
                print 'working on chunknum', chunknum, 'loind', loind, 'hiind', hiind, 'overlap', overlap, 'timeseries size', len(timeseries), 'chunk size', chunk.shape, 'chunklen', chunklen
